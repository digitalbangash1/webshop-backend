...
namespace webshop_backend.Repositories
{
...

    {
        ...
        private static string connectionString = "server=localhost;port=3306;database=webshop;user=root;password=Wajiha3330";
            //"mysql-database-db.admin.samat.diplomportal.dk";
