...
namespace webshop_backend.Controllers
{
    ...
    public class ProductsController : BaseController
    {
        ...
        {
            ProductsRespository.CreateProduct(model.name, model.description, (int)model.price, model.quantity);
            return Ok();
        } 
        ...
        {
            ProductsRespository.UpdateProduct(id, model.name, model.description, (int)model.price, model.quantity);
            return Ok();
        }
    }
}
